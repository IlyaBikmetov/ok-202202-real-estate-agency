...
enum class AdRequestDebugStubs(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is AdRequestDebugStubs) "$data" else null

        /**
         * Returns a valid [AdRequestDebugStubs] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): AdRequestDebugStubs? = data?.let {
