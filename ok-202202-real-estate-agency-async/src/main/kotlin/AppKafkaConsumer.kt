...
interface ConsumerStrategy {
    ...
    fun serialize(source: ReAgContext): String
    fun deserialize(value: String, target: ReAgContext)
}
...
class AppKafkaConsumer(
    ...
    private fun sendResponse(context: ReAgContext, strategy: ConsumerStrategy, outputTopic: String) {
